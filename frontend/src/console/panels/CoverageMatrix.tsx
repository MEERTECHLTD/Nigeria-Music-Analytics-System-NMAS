  ...
  return (
    <>
      ...
      <Section
        ...
        subtitle="Cell shade carries the share of the 131-artist roster observed in that quarter. Select any cell for its source, endpoint, call timestamp and record count."
